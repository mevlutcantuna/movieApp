    ...
    <div className="navbar">
      <div className="navbar__right">
        ...
        <div className="navbar__right__link">
          ...
          <Link style={linkStyle} to={routes.Favourites.path}>
            {routes.Favourites.title}
          </Link>
        </div>
      </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    getSearchItems: (name, year, type) =>
      dispatch(getSearchItems(name, year, type)),
    handleName: (e) =>
      dispatch({
